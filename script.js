    ...
    function getSpeakerData(speakerId) {
        ...
        const sessionDetails = {
            ...
            'tonochi': {
                keyPoints: [
                    {
                        title: 'AIマンガ制作の全工程ライブ解説',
                        description: 'プロット作成からネーム、下描き、仕上げまで、AIと人の役割分担を実演。AI生成画像の活用法や、ストーリー展開の工夫も具体的に紹介。',
                        icon: '📖'
                    },
                    {
                        title: 'AIツールの選定と使い分け',
                        description: '画像生成AI（例：Midjourney等）や文章生成AIを工程ごとに使い分け。AIの得意・不得意を見極めて、手作業と組み合わせるポイントを解説。',
                        icon: '🤖'
                    },
                    {
                        title: '著作権・倫理・フィードバック活用',
                        description: 'AI生成物の著作権や倫理面の注意点、フィードバックを活かした作品ブラッシュアップの実践例を紹介。',
                        icon: '⚖️'
                    }
                ],
                practicalTips: [
                    'AI画像生成は「指示の具体性」がクオリティを左右する',
                    'ストーリーやキャラ設定は事前に明確化しておく',
                    'AIの出力はそのまま使わず、必ず人の目でチェック・修正',
                    '著作権や倫理面に配慮し、商用利用時は特に注意',
                    'フィードバックをもとに何度もブラッシュアップする'
                ],
                sessionNotes: [
                    'AIと人の役割分担が高品質なマンガ制作の鍵',
                    'AIツールの進化で制作効率と表現力が大幅向上',
                    '著作権・倫理面の配慮が今後ますます重要に',
                    'フィードバックを活かした継続的な改善が作品の質を高める',
                    'AI時代の創作には新しい学びと柔軟な姿勢が求められる'
                ]
            },
            'fujita': {
                keyPoints: [
                    {
                        title: '企業におけるAIエージェント活用の最前線',
                        description: '実際の企業現場でAIエージェントがどのように導入・活用されているか、具体的な事例を交えて解説。現場の課題や導入時の工夫も紹介。',
                        icon: '🏢'
                    },
                    {
                        title: '導入成功のポイントと失敗事例',
                        description: 'AIエージェント導入で成果を出すためのポイント（現場の巻き込み・段階的導入・目的明確化など）や、よくある失敗パターン・その対策を体系的に整理。',
                        icon: '✅'
                    },
                    {
                        title: '今後の展望と現場の声',
                        description: 'AIエージェントの今後の進化や、現場から寄せられたリアルな声・期待・課題を紹介。企業のAI活用がどう変わるかを展望。',
                        icon: '🔮'
                    }
                ],
                practicalTips: [
                    '導入目的を明確にし、現場の課題に即したAIエージェントを設計',
                    '小さな成功体験を積み重ねて現場に浸透させる',
                    '現場の声を積極的に取り入れ、運用を柔軟に改善',
                    'セキュリティ・プライバシー面の配慮を徹底',
                    '継続的な教育・サポート体制を整備する'
                ],
                sessionNotes: [
                    'AIエージェントは現場の課題解決に直結するツールとして期待大',
                    '導入時は現場の巻き込みと段階的な展開が成功の鍵',
                    '失敗事例から学び、柔軟な運用改善が重要',
                    '現場の声を反映したAI活用が企業全体の成長につながる',
                    '今後はより高度なAIエージェントが現場を支える時代へ'
                ]
            }
        };
